...
class MsbA2BSigmoid : public UnaryKernel {
 public:
  static constexpr char kBindName[] = "msb_a2b_sigmoid";

  MsbA2BSigmoid(size_t nbits = 0, uint64_t low_seg = 0, uint64_t high_seg = 0,
                size_t skip_bits = 0)
      : nbits_(nbits),
        low_seg_(low_seg),
        high_seg_(high_seg),
        skip_bits_(skip_bits) {}
